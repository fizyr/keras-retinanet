...
class MobileNetV2Backbone(Backbone):
    ...
    allowed_backbones = ['mobilenetv2_128', 'mobilenetv2_160', 'mobilenetv2_192', 'mobilenetv2_224']

    def retinanet(self, *args, **kwargs):
        """ Returns a retinanet model using the correct backbone.
        """
        return mobilenetv2_retinanet(*args, backbone=self.backbone, **kwargs)
    ...
    def download_imagenet(self):
        ...
        #rows = int(self.backbone.split('_')[0].replace('mobilenetv2', ''))
        rows = int(self.backbone.split('_')[1])
    ...
    def validate(self):
        ...
        """
        backbone = '_'.join([self.backbone.split('_')[0], self.backbone.split('_')[1]])
...
def mobilenetv2_retinanet(num_classes, backbone='mobilenetv2_224_1.0', inputs=None, modifier=None, **kwargs):
